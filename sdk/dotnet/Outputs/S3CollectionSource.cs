...
namespace Pulumi.Rockset.Outputs
{
    ...
    [OutputType]
    public sealed class S3CollectionSource
    {
        /// <summary>
        /// S3 bucket containing the target data.
        /// </summary>
        public readonly string Bucket;
        public readonly Outputs.S3CollectionSourceCsv? Csv;
        /// <summary>
        ...
        public readonly Outputs.S3CollectionSourceXml? Xml;

        [OutputConstructor]
        private S3CollectionSource(
            string bucket,

            Outputs.S3CollectionSourceCsv? csv,
            ...
            Outputs.S3CollectionSourceXml? xml)
        {
            Bucket = bucket;
            Csv = csv;
            Format = format;
