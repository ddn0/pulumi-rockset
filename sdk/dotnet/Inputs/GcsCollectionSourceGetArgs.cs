...
namespace Pulumi.Rockset.Inputs
{
    ...
    public sealed class GcsCollectionSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("csv")]
        public Input<Inputs.GcsCollectionSourceCsvGetArgs>? Csv { get; set; }
        ...
        [Input("xml")]
        public Input<Inputs.GcsCollectionSourceXmlGetArgs>? Xml { get; set; }

        public GcsCollectionSourceGetArgs()
        {
        }
        public static new GcsCollectionSourceGetArgs Empty => new GcsCollectionSourceGetArgs();
    }
}
