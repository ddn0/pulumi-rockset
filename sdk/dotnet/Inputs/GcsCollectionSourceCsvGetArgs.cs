...
namespace Pulumi.Rockset.Inputs
{
    ...
    public sealed class GcsCollectionSourceCsvGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("columnNames")]
        ...
        public GcsCollectionSourceCsvGetArgs()
        {
        }
        public static new GcsCollectionSourceCsvGetArgs Empty => new GcsCollectionSourceCsvGetArgs();
    }
}
