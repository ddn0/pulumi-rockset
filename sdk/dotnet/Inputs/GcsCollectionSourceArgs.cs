...
namespace Pulumi.Rockset.Inputs
{
    ...
    public sealed class GcsCollectionSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("csv")]
        public Input<Inputs.GcsCollectionSourceCsvArgs>? Csv { get; set; }
        ...
        [Input("xml")]
        public Input<Inputs.GcsCollectionSourceXmlArgs>? Xml { get; set; }

        public GcsCollectionSourceArgs()
        {
        }
        public static new GcsCollectionSourceArgs Empty => new GcsCollectionSourceArgs();
    }
}
