...
namespace Pulumi.Rockset.Inputs
{
    ...
    public sealed class KafkaCollectionSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("statuses")]
        private InputList<Inputs.KafkaCollectionSourceStatusArgs>? _statuses;
        public InputList<Inputs.KafkaCollectionSourceStatusArgs> Statuses
        {
            get => _statuses ?? (_statuses = new InputList<Inputs.KafkaCollectionSourceStatusArgs>());
            set => _statuses = value;
        }
        ...
        public KafkaCollectionSourceArgs()
        {
        }
        public static new KafkaCollectionSourceArgs Empty => new KafkaCollectionSourceArgs();
    }
}
