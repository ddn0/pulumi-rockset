...
namespace Pulumi.Rockset.Inputs
{
    ...
    public sealed class S3CollectionSourceGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("csv")]
        public Input<Inputs.S3CollectionSourceCsvGetArgs>? Csv { get; set; }
        ...
        [Input("xml")]
        public Input<Inputs.S3CollectionSourceXmlGetArgs>? Xml { get; set; }

        public S3CollectionSourceGetArgs()
        {
        }
        public static new S3CollectionSourceGetArgs Empty => new S3CollectionSourceGetArgs();
    }
}
