...
namespace Pulumi.Rockset.Inputs
{
    ...
    public sealed class S3CollectionSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("csv")]
        public Input<Inputs.S3CollectionSourceCsvArgs>? Csv { get; set; }
        ...
        [Input("xml")]
        public Input<Inputs.S3CollectionSourceXmlArgs>? Xml { get; set; }

        public S3CollectionSourceArgs()
        {
        }
        public static new S3CollectionSourceArgs Empty => new S3CollectionSourceArgs();
    }
}
