...
namespace Pulumi.Rockset
{
    ...
    /// ```
    /// </summary>
    [RocksetResourceType("rockset:index/kafkaCollection:KafkaCollection")]
    public partial class KafkaCollection : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("sources")]
        public Output<ImmutableArray<Outputs.KafkaCollectionSource>> Sources { get; private set; } = null!;
        ...
        public KafkaCollection(string name, KafkaCollectionArgs args, CustomResourceOptions? options = null)
            : base("rockset:index/kafkaCollection:KafkaCollection", name, args ?? new KafkaCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KafkaCollection(string name, Input<string> id, KafkaCollectionState? state = null, CustomResourceOptions? options = null)
            : base("rockset:index/kafkaCollection:KafkaCollection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KafkaCollection Get(string name, Input<string> id, KafkaCollectionState? state = null, CustomResourceOptions? options = null)
        {
            return new KafkaCollection(name, id, state, options);
        }
    }

    public sealed class KafkaCollectionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Text describing the collection.
        /// </summary>
        ...
        [Input("sources")]
        private InputList<Inputs.KafkaCollectionSourceArgs>? _sources;

        /// <summary>
        /// Defines a source for this collection.
        /// </summary>
        public InputList<Inputs.KafkaCollectionSourceArgs> Sources
        {
            get => _sources ?? (_sources = new InputList<Inputs.KafkaCollectionSourceArgs>());
            set => _sources = value;
        }
        ...
        public KafkaCollectionArgs()
        {
        }
        public static new KafkaCollectionArgs Empty => new KafkaCollectionArgs();
    }

    public sealed class KafkaCollectionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Text describing the collection.
        /// </summary>
        ...
        [Input("sources")]
        private InputList<Inputs.KafkaCollectionSourceGetArgs>? _sources;

        /// <summary>
        /// Defines a source for this collection.
        /// </summary>
        public InputList<Inputs.KafkaCollectionSourceGetArgs> Sources
        {
            get => _sources ?? (_sources = new InputList<Inputs.KafkaCollectionSourceGetArgs>());
            set => _sources = value;
        }
        ...
        public KafkaCollectionState()
        {
        }
        public static new KafkaCollectionState Empty => new KafkaCollectionState();
    }
}
