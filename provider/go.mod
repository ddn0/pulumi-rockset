module github.com/ddn0/pulumi-rockset/provider
...
require (
	...
	github.com/rockset/terraform-provider-rockset v0.9.1
)
...
require (
	...
	github.com/rockset/rockset-go-client v0.22.3 // indirect
